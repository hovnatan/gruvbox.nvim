...
groups.setup = function()
  ...
  local groups = {
    ...
    GruvboxRedUnderline = { underline = config.undercurl, sp = colors.red },
    GruvboxGreenUnderline = { underline = config.undercurl, sp = colors.green },
    GruvboxYellowUnderline = { underline = config.undercurl, sp = colors.yellow },
    GruvboxBlueUnderline = { underline = config.undercurl, sp = colors.blue },
    GruvboxPurpleUnderline = { underline = config.undercurl, sp = colors.purple },
    GruvboxAquaUnderline = { underline = config.undercurl, sp = colors.aqua },
    GruvboxOrangeUnderline = { underline = config.undercurl, sp = colors.orange },
